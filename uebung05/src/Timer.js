...
class Timer extends Component {
    constructor(props) {
        ...
        this.countdown = 0;
        this.state = {time: "Bitte Zeit eingeben.", render: true};
    ...
    render() {
        return(<>
            ...
            <Grid container>
                <Grid style={{margin: 20, fontSize: 30}}>
                    {this.state.time}
                </Grid>
            </Grid>
            <Button size="large" variant="contained" color="primary" onClick={this.click}>Start</Button>
            {this.state.render &&
            <Grid container>
